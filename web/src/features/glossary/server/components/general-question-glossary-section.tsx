...
export function GeneralQuestionGlossarySection({ terms }: Props) {
  if (terms.length === 0) return null;

  return (
    <section className="mt-8 rounded-xl border border-emerald-200 bg-emerald-50/60 p-5 md:p-6">
      <div className="flex items-center gap-2">
        <BookOpen className="h-5 w-5 text-emerald-700" aria-hidden="true" />
        <h2 className="text-xl font-bold">この一般質問に出てくる用語</h2>
      </div>
